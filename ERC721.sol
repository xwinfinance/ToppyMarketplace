 ...
 */
contract ToppyNFT is Context, AccessControl, ERC721Burnable, ERC721Pausable {
    using Counters for Counters.Counter;
 
    ToppyToken public _ToppyToken; 
    xWinDefi public _xWinDefi;
    uint public freeTokenAmount = 1e18;
    uint public toppyFarmId = 0;
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, string memory baseURI, address toppyToken_, address xWinDefi_) public ERC721(name, symbol) {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());

        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(PAUSER_ROLE, _msgSender());
        _setBaseURI(baseURI);
        _ToppyToken = ToppyToken(toppyToken_);
    ...
    function burn(uint256 tokenId) public override {
        ...
        //_xWinDefi.WithdrawFarm(toppyFarmId, freeTokenAmount);
        //_ToppyToken.burn(freeTokenAmount);
    }
